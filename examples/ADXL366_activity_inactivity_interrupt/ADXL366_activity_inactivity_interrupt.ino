...
void setup() {
  ...
  Serial.println("ADXL366_Sketch - Activity and Inactivity Interrupts");
  Serial.println();
  if (!myAcc.init()) {
...
/* Three parameters have to be set for activity:
    ...
    3. Threshold in g
*/
  myAcc.setActivityParameters(ADXL366_DC_MODE, ADXL366_XY0, 0.5);
...
*/  
  myAcc.setInactivityParameters(ADXL366_DC_MODE, ADXL366_XY0, 0.5, 10.0);
