...
*
* This sketch shows how to measure pitch and roll angles of the ADXL366
* vs. the corrected angle method.
* It does not use the internal offset registers.
* Please note the ADXL366 "forgets" calibration data when reset or repowered.
...
void setup(){
  Wire.begin();
  Serial.begin(115200);
  Serial.println("ADXL366 Sketch - Pitch and Roll vs. Corrected Angles");
  Serial.println();
  if(!myAcc.init()){
    Serial.println("ADXL366 not connected!");
  }
  
/* Add your min and max raw values you found with ADXL366_calibration.ino.  
...
*/
  Serial.println("Position your ADXL366 flat and don't move it");
  delay(2000);
